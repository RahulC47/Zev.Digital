...
/**
 * Sliding pill toggle — DAY MODE (light) / NIGHT MODE (dark).
 * Knob slides right→left when switching day→night, matching the reference design.
 */
    ...
    >
      ...
      <span
        style={{
          ...
          zIndex: 2,
          boxShadow: isLight ? '0 1px 4px rgba(0,0,0,0.12)' : '0 1px 4px rgba(0,0,0,0.5)',
        }}
      >
        {isLight ? <SunIcon /> : <MoonIcon />}
      </span>

      {/* Text label — opposite side of the knob */}
      <span
        style={{
          position: 'absolute',
          left: isLight ? 10 : 38,
